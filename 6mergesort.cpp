...
int main()
{
	...
	mergeSortFuncion(a2, 0, p - 1, menorFuncion);
	...
	mergeSortTemplate<int, CLess<int>>(a4, 0, p - 1);
	...
	mergeSortInline<int, InlineLess<int>>(a5, 0, p - 1);
